...
namespace Market365_3._0.Administrator.ZamowienieKlientow
{
    public partial class ZamowienieKlientow : System.Web.UI.Page
    {
        User currUser;
        String Polaczenie;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter ada = new SqlDataAdapter("SELECT DISTINCT[orders].Id,[orders].value, [orders].status, [orders].name, [orders].surname " +
                "from[orders]", sql);
