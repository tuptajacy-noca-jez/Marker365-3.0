     ...
     <div>
        <div>
            ...
            <table>
                <tr>
                    <td>
                        <asp:TextBox ID="login" runat="server" placeholder="Login" CssClass="ceil" BorderStyle="Solid" Font-Size="X-Large" AutoPostBack="True" OnTextChanged="login_TextChanged"></asp:TextBox>
                ...
                <tr>
                    <td>
                        <asp:TextBox ID="password" runat="server" placeholder="Hasło" CssClass="ceil" BorderStyle="Solid" Font-Size="X-Large" AutoPostBack="True" ToolTip="Hasło musi składać się z min. 8 znaków, zawierać małe i duże litery, cyfrę oraz znak specjalny" TextMode="Password"></asp:TextBox>
                    ...
                    <td>
                             <asp:TextBox ID="passwordConfirm" runat="server" placeholder="Potwierdz nowe Hasło" AutoPostBack="True" BorderStyle="Solid" CssClass="ceil" Font-Size="X-Large" TextMode="Password" ToolTip="Hasło musi składać się z min. 8 znaków, zawierać małe i duże litery, cyfrę oraz znak specjalny"></asp:TextBox>
