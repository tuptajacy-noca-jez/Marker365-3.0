...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
     <div>
            ...
            <table>
                ...
                <tr>
                    <td>
                        <asp:TextBox ID="newPassword" runat="server" placeholder="Nowe Hasło" AutoPostBack="True" BorderStyle="Solid" CssClass="ceil" Font-Size="X-Large" TextMode="Password" ToolTip="Hasło musi składać się z min. 8 znaków, zawierać małe i duże litery, cyfrę oraz znak specjalny" MaxLength="49"></asp:TextBox>
                    ...
                    <td>
                        <asp:TextBox ID="newPasswordConfirm" runat="server" placeholder="Potwierdz nowe Hasło" AutoPostBack="True" BorderStyle="Solid" CssClass="ceil" Font-Size="X-Large" TextMode="Password" ToolTip="Hasło musi składać się z min. 8 znaków, zawierać małe i duże litery, cyfrę oraz znak specjalny" MaxLength="49"></asp:TextBox>
