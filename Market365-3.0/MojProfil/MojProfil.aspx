    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table>
                ...
                <tr>
                    <td>
                        <asp:TextBox ID="newPassword" runat="server" placeholder="Nowe Hasło" AutoPostBack="True" BorderStyle="Solid" CssClass="ceil" Font-Size="X-Large" TextMode="Password" ToolTip="Hasło musi składać się z min. 8 znaków, zawierać małe i duże litery"></asp:TextBox>
                        <asp:RegularExpressionValidator ID="newPasswordValidator" runat="server" ErrorMessage="Hasło nie spełnia wymagań" Font-Size="X-Large" ForeColor="Red" ValidationExpression="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$" ControlToValidate="newPassword" ValidationGroup="profileChanges">*</asp:RegularExpressionValidator>
                    ...
                    <td>
                        <asp:TextBox ID="newPasswordConfirm" runat="server" placeholder="Potwierdz nowe Hasło" AutoPostBack="True" BorderStyle="Solid" CssClass="ceil" Font-Size="X-Large" TextMode="Password" ToolTip="Hasło musi składać się z min. 8 znaków, zawierać małe i duże litery"></asp:TextBox>
                        <asp:RegularExpressionValidator ID="newPasswordConfirmValidator" runat="server" ErrorMessage="Hasło nie spełnia wymagań" Font-Size="X-Large" ForeColor="Red" ValidationExpression="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$" ControlToValidate="newPasswordConfirm" ValidationGroup="profileChanges">*</asp:RegularExpressionValidator>
